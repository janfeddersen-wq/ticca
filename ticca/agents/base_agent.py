...
from ticca.mcp_ import ServerConfig, get_mcp_manager
from ticca.messaging import (
    emit_error,
    emit_info,
    emit_warning,
)
from ticca.messaging.spinner import (
    SpinnerBase,
    update_spinner_context,
)
from ticca.model_factory import ModelFactory
from ticca.summarization_agent import run_summarization_sync
from ticca.tools.agent_tools import _active_subagent_tasks
...
class BaseAgent(ABC):
    ...
    def message_history_processor(
        ...
        from ticca.tui_state import get_tui_app_instance, is_tui_mode
    ...
    # ===== Agent wiring formerly in ticca/agent.py =====
    ...
    async def run_with_mcp(
        ...
        **kwargs,
        ...
        def schedule_agent_cancel() -> None:
            from ticca.tools.command_runner import _RUNNING_PROCESSES
