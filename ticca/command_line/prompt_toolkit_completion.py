...
from ticca.command_line.attachments import (
    DEFAULT_ACCEPTED_DOCUMENT_EXTENSIONS,
    DEFAULT_ACCEPTED_IMAGE_EXTENSIONS,
    _detect_path_tokens,
    _tokenise,
)
from ticca.command_line.command_registry import get_unique_commands
from ticca.command_line.file_path_completion import FilePathCompleter
from ticca.command_line.load_context_completion import LoadContextCompleter
from ticca.command_line.mcp_completion import MCPCompleter
from ticca.command_line.model_picker_completion import (
    ModelNameCompleter,
    get_active_model,
)
from ticca.command_line.pin_command_completion import PinCompleter
from ticca.command_line.utils import list_directory
...
class AgentCompleter(Completer):
    ...
    def get_completions(self, document, complete_event):
        ...
        try:
            from ticca.command_line.pin_command_completion import load_agent_names
